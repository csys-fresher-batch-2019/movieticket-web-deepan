...
<img src="assets/images/<%= movie.getImageUrl()%>" class="card-img-top" alt="...">

<div class="card-body">
<h5 class="card-title"><%=movie.getMovieName() %></h5>
<p class="card-text">
<span class="btn btn-success btn-sm"><%=movie.getMovieLanguage() %> </span> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<span class="btn btn-danger btn-sm"><%=movie.getMovieType() %> </span>
<br/>
<br/>
<span class="btn btn-dark btn-sm">Rating: <%=movie.getMovieRating() %> </span>&nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
<span class="btn btn-warning btn-sm">Hours: <%=movie.getMovieDuration() %></span></p>
